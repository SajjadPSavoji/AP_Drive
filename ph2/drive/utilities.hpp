...
void make_login_command(std::string username , std::string pass , std::vector<std::string> &command_splited);
void make_logout_command(std::vector<std::string> &command_splited);
void make_userlist_command(std::vector<std::string> &command_splited );
void make_adduser_command(std::vector<std::string> &command_splited , std::string username , std::string password);
